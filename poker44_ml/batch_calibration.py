...
_BUILD_VARIANT_K7C = "k7c"
_BUILD_FINGERPRINT_K7C = "20ac00f337ff35c3b4b0b39e"
_BUILD_SALT_K7C = "5ff897b7bffc5e0f"


def _build_provenance_K7C():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_K7C, _BUILD_FINGERPRINT_K7C, _BUILD_SALT_K7C)
